...
<html lang="es">
	...
	<head>
        ...
        <script type="text/javascript" src="../js/borrarPatron.js"></script> <!-- Ajax -->
            ...
            <section id="contenido"> 
               ...
               <div id="misPatrones">
					<?php 
						...
						$db->connect();
						// Sentencia SELECT
						$sql="SELECT * FROM patrones WHERE usuario='".$_GET["usuario"]."';";
