...
<html lang="es">
	...
	<head>
        ...
        <script type="text/javascript" src="../../js/borrarProduct.js"></script> <!-- Ajax -->
        <style type="text/css"> #borrarProduct { background-color:grey; border:none; outline:none;} </style>
            ...
            <section id="contenido"> 
                ...
                <div class="container" style="position:relative;top:25px;">
                    <div class="panel panel-primary" style="border-color:grey;">
                        <div class="panel-heading" style="background:#4D4D4D;border:none;"> Borrar producto </div>
                            ...
                            <?php
                                ...
                                if($select){
                                    ...
                                    foreach ($select as $key => $valor) {
                                        ...
                                        echo "<td>"?><a id="borrarProduct" name="borrarProduct" onclick="borrarProduct('<?php echo htmlspecialchars($codigoBarras); ?>')" class="btn btn-primary"><span class="glyphicon glyphicon-trash"></span></a> <?php "</td>";
                                        echo "</tr>";
                                    } // Cierre del foreach                                  
                                }
                            ?> 
