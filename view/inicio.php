		...
		<div id="container">
            ...
            <section id="contenido"> 
                <center><table border="2" bordercolor="white">                    
                    <tr><!-- Fila 1 -->
                        <td>
                            <a href="colecciones.php"><img id="coleccionesA" alt="Colecciones"></a>
                        </td>
                        <td>
                            <a href="campanas.php"><img id="campanas" alt="Campañas"></a>
                        </td>
                        <!--<td rowspan="2">
                    ...
                    <tr><!-- Fila 2 -->
                        <td>
                            <a href="colecciones.php"><img id="coleccionesB" alt="Colecciones"></a>
                            </td>
                        <td>
                            <a href="blog.php"><img id="blog" align="center" alt="Blog"></a>
                        </td>                        
                    </tr>
                </table></center>                
