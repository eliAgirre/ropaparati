function validarRegistro(){
	// Obtiene el valor del input username del formulario con el nombre alta
	var username=document.forms["alta"]["username"].value;
	// Se eliminan los espacios del principio y final
	username=username.trim();

	var password1=document.forms["alta"]["password"].value;
	password1=password1.trim();

	var password2=document.forms["alta"]["password2"].value;
